...
<html>
	<head>
		...
		<link rel="apple-touch-icon" href="touch-icon-ipad.png?m=<?php echo filemtime('apple-touch-icon.png'); ?>" />
		<link rel="apple-touch-icon" sizes="152x152" href="touch-icon-ipad.png?m=<?php echo filemtime('apple-touch-icon.png'); ?>" />
		<link rel="apple-touch-icon" sizes="180x180" href="touch-icon-iphone-retina.png?m=<?php echo filemtime('apple-touch-icon.png'); ?>" />
		<link rel="apple-touch-icon" sizes="167x167" href="touch-icon-ipad-retina.png?m=<?php echo filemtime('apple-touch-icon.png'); ?>" />
